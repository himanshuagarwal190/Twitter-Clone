        ...
        <main className="flex justify-center items-center w-full h-full mb-8">
            ...
            <div className="flex flex-col bg-blue-600 w-1/2 h-full justify-center items-center">
                <div className="m-5 self-start ml-40 flex">
                    <svg className="w-8 mr-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div className="m-5 self-start ml-40 flex">
                    ...
                    <p className="font-bold text-xl">Hear what people are talking about.</p>
                </div>
                <div className="m-5 self-start ml-40 flex">
                    <svg className="w-8 mr-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <svg viewBox="328 355 335 276" xmlns="http://www.w3.org/2000/svg" className="w-10 mb-5 self-start ml-28">
              <path d="
                M 630, 425
                ...
                <p className="text-3xl font-bold self-start ml-28">See what's happening in <br /> the world right now</p>
                <p className="mt-14 mb-1 font-bold self-start ml-28">Join Twitter today.</p>
                <Link to="/signup" className="border rounded-3xl h-10 font-bold text-center text-lg pt-1 mt-5 bg-blue-500 border-blue-500 w-2/3">Sign up</Link>
                <Link to="/login" className="border rounded-3xl h-10 font-bold text-center text-lg pt-1 mt-5 border-blue-500 text-blue-500 w-2/3">Log in</Link>
            </div>
        </main>
