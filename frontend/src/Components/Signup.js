        ...
        <div className="bg-gray-800 h-screen flex justify-center">
            ...
            <div className="m-10 flex flex-col">
                ...
                <form className="flex flex-col">
                    ...
                    <input onChange={e => setHandle(e.target.value)} className="w-96 mt-6 h-10 bg-gray-800 border border-white text-white rounded px-2" type="handle" name="handle" placeholder="@Handle"/>
                    <input onClick={onSubmit} className="w-96 mt-6 h-10 bg-gray-800 border border-white text-white rounded px-2 cursor-pointer" type="submit" value="Sign Up" />
                </form>
            </div>
        </div>
    )
